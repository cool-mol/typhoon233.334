...
class AutoTrader(BaseAutoTrader):
    ...
    def __init__(self, loop: asyncio.AbstractEventLoop, team_name: str, secret: str):
        ...
        self.buy_prices = list()    # 购买价队列
        self.sell_prices = list()   # 卖出价队列
        self.entries = 0            # 队列中的条目数
        self.positions = 0          # 持仓数
        self.buy_price = None
    ...
    def if_buy(self, buy_price):
        ...
        print('----------------------')
        if self.is_above_cloud(cloudPoint, buy_price) and self.positions == 0 and conversionLine > baseLine:
